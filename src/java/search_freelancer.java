 ...
 * @author margs
 */
public class search_freelancer extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		PreparedStatement ps = c.prepareStatement("select * from sign_up where services=?");
...
"  </tr>");
		...
		out.println("No clients at the moment :/");
		return;
